...
| KC-03C | Persist admitted source originals and deterministic extractions privately. | **Complete locally:** permitted originals/extractions are content-addressed in R2, metadata/hashes/keys are recorded in D1, repeated captures are idempotent, and the R2 reconciliation operation verifies both artefacts. The KC-03E consumer and manual route use this boundary. See [`docs/audit/kc-03c-private-source-capture-evidence.md`](docs/audit/kc-03c-private-source-capture-evidence.md). |
...
| KC-03E | Consume admitted capture jobs and add publisher-only manual URL capture. | **Complete locally:** the Preview consumer retrieves bounded HTML through KC-03A, extracts through KC-03B, persists through KC-03C, records failed/completed job state, and retries to the configured DLQ. Signed publishers can enqueue manual URLs through `/admin/knowledge/capture-url`; production remains unbound. See [`docs/audit/kc-03e-capture-consumer-manual-url-evidence.md`](docs/audit/kc-03e-capture-consumer-manual-url-evidence.md). |
| KC-04A–C | Add deterministic structured extraction, source summaries, and mandatory locators. | **Complete locally:** migration 0034 records typed, review-gated extraction candidates and summaries with versioned method/policy/usage/cost metadata; each candidate resolves to a persisted `source_chunk` and locator, while material/benchmark candidates create proposed canonical claim assertions. Reprocessing an unchanged source is idempotent and records zero external-AI cost. See [`docs/audit/kc-04-deterministic-extraction-evidence.md`](docs/audit/kc-04-deterministic-extraction-evidence.md). |
| KC-04D | Store extraction model, prompt, policy, source-version, usage, validation, idempotency and audit metadata. | **Complete locally:** migration 0035 adds a durable extraction-run envelope and output links. Deterministic runs record source hashes, prompt identity, policy/version, zero-cost usage, validation outcome, correlation/audit metadata, and a stable idempotency key; no external-AI call or production binding is enabled. See [`docs/audit/kc-04d-extraction-metadata-evidence.md`](docs/audit/kc-04d-extraction-metadata-evidence.md). |
| KC-04E | Add publisher review states and attributable transitions for extracted candidates and summaries. | **Complete locally:** migration 0036 records review history; the publisher-only API validates target-specific states, bounded amendments, legal transitions, and writes admin audit outcomes. No review automatically promotes public evidence. See [`docs/audit/kc-04e-review-workflow-evidence.md`](docs/audit/kc-04e-review-workflow-evidence.md). |
| KC-04F | Prove unchanged extraction content does not incur another external-AI charge. | **Complete locally:** `knowledge-extraction-cache.ts` claims a source/task/model/prompt/policy identity before provider invocation, returns completed runs as cache hits, settles one usage/cost record, and retries failed runs. Regression tests prove an unchanged governed-AI request calls the simulated provider once and records one cost. See [`docs/audit/kc-04f-cache-idempotency-evidence.md`](docs/audit/kc-04f-cache-idempotency-evidence.md). |
| KC-05A | Match extracted claims to existing canonical claims using deterministic candidate signals. | **Complete locally:** migration 0037 and `claim-match-candidates.ts` create idempotent, review-gated proposals from material/benchmark extractions using lexical, entity, value, date, and labelled lexical-cosine semantic-proxy signals. The extraction’s own canonical claim is excluded; no merge, provenance membership, or evidence score is changed. Real embedding/Vectorize retrieval remains KC-09. See [`docs/audit/kc-05a-claim-match-candidate-evidence.md`](docs/audit/kc-05a-claim-match-candidate-evidence.md). |
| KC-05B | Let the editor merge with an existing claim, create a new claim, or reject the candidate. | **Complete locally:** migration 0038 records attributable claim-match review history; `claim-match-review.ts`, the publisher API, and Claim Match Review UI support merge-existing, create-new, and reject decisions. Accepted decisions resolve the source assertion and supersede competing proposals; no provenance group or evidence score is created automatically. See [`docs/audit/kc-05b-claim-match-review-evidence.md`](docs/audit/kc-05b-claim-match-review-evidence.md). |
| KC-05C | Propose provenance relationships and claim-relative directness, source role, and evidentiary treatment. | **Complete locally:** migration 0039 records deterministic provenance proposals and review history; accepted KC-05B decisions create idempotent proposals with confidence/rationale and mandatory-review flags for uncertain or high-materiality lineage. Publisher review updates assertion metadata only; no provenance group/membership or evidence score is created. See [`docs/audit/kc-05c-provenance-proposal-evidence.md`](docs/audit/kc-05c-provenance-proposal-evidence.md). |
| KC-05D | Group derivative coverage under a shared origin. | **Complete locally:** migration 0040 and `provenance-group-proposals.ts` detect distinct source documents sharing an exact immutable content hash and create mandatory-review root/derivative proposals. Publisher acceptance creates the provenance group and memberships and links source assertions; no evidence score is recalculated. See [`docs/audit/kc-05d-shared-origin-grouping-evidence.md`](docs/audit/kc-05d-shared-origin-grouping-evidence.md). |
| KC-05E | Detect support, qualification, contradiction, reproduction, correction, temporal change, and supersession at claim level. | **Complete locally:** migration 0041 and `claim-relationship-proposals.ts` classify deterministic relationship proposals from lexical overlap and explicit relationship cues. Publisher review can accept/reject each proposal; acceptance adds a reviewed relation assertion while preserving claim state and evidence scores. See [`docs/audit/kc-05e-claim-relationship-evidence.md`](docs/audit/kc-05e-claim-relationship-evidence.md). |
| KC-05F | Preserve unresolved conflicts instead of forcing a consensus. | **Complete locally:** migration 0042 materializes explicit unresolved conflict cases from accepted contradiction/correction/supersession/temporal-change relations. Publisher acknowledge/resolve/dismiss/reopen decisions are audited; no claim side, state, or evidence score is selected automatically. See [`docs/audit/kc-05f-conflict-preservation-evidence.md`](docs/audit/kc-05f-conflict-preservation-evidence.md). |
| KC-05G | Complete legacy claims mapping and route cutover. | **Complete locally:** migration 0043 maps governed legacy claims/evidence into canonical claims/assertions, quarantines unclassified legacy rows, preserves story links and legacy IDs, freezes legacy tables read-only, and routes extraction, correction, conflict discovery, and Ask TRACE through canonical data without dual writes. See [`docs/audit/kc-05g-legacy-claims-cutover-evidence.md`](docs/audit/kc-05g-legacy-claims-cutover-evidence.md). |
| KC-06A | Replace the read-only Find Related list with explainable editorial candidates. | **Complete locally:** ranked candidates use lexical/topic, entity, canonical-claim, date, provenance-group, and deterministic semantic-proxy signals. See [`docs/audit/kc-06-related-workflow-evidence.md`](docs/audit/kc-06-related-workflow-evidence.md). |
| KC-06B | Add publisher actions for related candidates. | **Complete locally:** migration 0044 records idempotent publisher decisions for same event, evidence review, follow-up, context, contradiction, correction, supersession, comparison, and rejection; accepted story actions create durable relationships, while eligible evidence actions hand off to KC-07B. See [`docs/audit/kc-06-related-workflow-evidence.md`](docs/audit/kc-06-related-workflow-evidence.md). |
| KC-06C | Persist claim-level evidence attachments with reviewer identity. | **Complete locally:** publisher-selected canonical claims can be attached to reviewed feed evidence with reviewer identity and idempotent records; only eligible attachments enter the KC-07B score input. See [`docs/audit/kc-06-related-workflow-evidence.md`](docs/audit/kc-06-related-workflow-evidence.md). |
| KC-06D | Keep evidence scores unchanged until eligible claim-level attachment is accepted. | **Complete locally:** related evidence actions classify attachments as eligible/pending/ineligible, reject stale lifecycle inputs, and defer score mutation until an eligible attachment is accepted; KC-07B then recalculates the affected claim/story. See [`docs/audit/kc-06-related-workflow-evidence.md`](docs/audit/kc-06-related-workflow-evidence.md). |
| KC-06E | Surface existing published stories and knowledge pages affected by accepted related evidence. | **Complete locally:** accepted related reviews return affected published stories and approved, non-expired knowledge documents linked through story relationships and canonical claims, with stable admin links. See [`docs/audit/kc-06-related-workflow-evidence.md`](docs/audit/kc-06-related-workflow-evidence.md). |
| KC-07A | Implement the versioned claim score and story roll-up policy. | **Complete locally:** policy `kc-07a-v1` scores reviewed canonical claims across six bounded components, applies lifecycle/conflict/source-role gates, rolls scores up by claim materiality, and adds immutable claim-score snapshot schema. See [`docs/audit/kc-07a-evidence-scoring-evidence.md`](docs/audit/kc-07a-evidence-scoring-evidence.md). |
| KC-07B | Recompute after accepted evidence, correction, provenance change, conflict resolution, expiry, withdrawal, or supersession. | **Complete locally:** `evidence-recalculation.ts` loads current reviewed canonical data, persists claim/story snapshots, updates qualitative story status, and is wired into related evidence, claim/provenance/conflict reviews, corrections, publication status changes, and the scheduled stale-evidence sweep. See [`docs/audit/kc-07b-automatic-recalculation-evidence.md`](docs/audit/kc-07b-automatic-recalculation-evidence.md). |
| KC-11A | Inventory all published stories, approved knowledge documents, static knowledge pages, Guides, corrections, models, providers, benchmarks, and source URLs. | **Complete locally:** `scripts/inventory-backfill.mjs` produces a read-only `kc-11a-v1` inventory from Preview D1 and repository-owned static inputs. The 27 July 2026 Preview baseline records 0 published/approved D1 content records, 16 static pages, 30 Markdown inputs, 23 Guide-related files, and 193 unique source URLs/references. See [`docs/audit/kc-11a-backfill-inventory-evidence.md`](docs/audit/kc-11a-backfill-inventory-evidence.md). |
| KC-11B | Produce a dry-run cost report and reviewed total backfill budget. | **Complete locally:** `scripts/backfill-cost-report.mjs` consumes `kc-11a-v1`, reports a conservative 2,316 routine governed-AI-call ceiling, 10,036,000 extraction input tokens, the KC-09 1,000,000-token embedding envelope, and an `$18.4435` static-baseline maximum. No budget is reserved and explicit batch approval remains required. See [`docs/audit/kc-11b-backfill-cost-evidence.md`](docs/audit/kc-11b-backfill-cost-evidence.md). |
