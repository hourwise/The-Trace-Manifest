...
export class SQLiteD1 {
  ...
  constructor(
    ...
    if (applyLegacyClaimsCutover) {
      this.sqlite.exec(readFileSync("db/migration-0043-legacy-claims-cutover.sql", "utf8"));
    }
  ...
  this.sqlite.exec(readFileSync("db/migration-0047-evidence-change-approvals.sql", "utf8"));
    ...
    this.sqlite.exec(readFileSync("db/migration-0067-kc-11g-h-remediation.sql", "utf8"));
    this.sqlite.exec(readFileSync("db/migration-0068-v1-freshness-review.sql", "utf8"));
  }
